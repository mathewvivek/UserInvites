			...
			<Container>
				...
				<TableContainer component={Paper} sx={{ mt: 8, mb: 4 }}>
					<Table sx={{ minWidth: 700 }} aria-label="customized table">
						<TableHead>
							<TableRow>
								<StyledTableCell>Invited Users</StyledTableCell>
								<StyledTableCell align="right">Invitation Accepted?</StyledTableCell>
								<StyledTableCell align="right">Invitation Sent Time</StyledTableCell>
							</TableRow>
						</TableHead>
						<TableBody>
							{rows.map((row) => (
